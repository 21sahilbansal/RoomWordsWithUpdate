    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWordViewModel.getAllWords().observe(this, new Observer<List<Word>>() {
            ...
            public void onChanged(@Nullable final List<Word> words) {
                ...
                Log.i("mvvm_room","1000 words observation time "+ String.valueOf(System.currentTimeMillis() - time));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i = 0 ; i < 1000 ; i++){
                    Word word = new Word("New Word"+i);
                    Long time = System.currentTimeMillis();
                    mWordViewModel.insert(word);
                    Log.i("mvvm_room",i + "1000 words insertion time "+ String.valueOf(System.currentTimeMillis() - time));
...
//                startActivityForResult(intent, NEW_WORD_ACTIVITY_REQUEST_CODE);
        ...
        ItemTouchHelper helper = new ItemTouchHelper(
                new ItemTouchHelper.SimpleCallback(0,
                    ...
                    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                        ...
                        Log.i("mvvm_room","single words deletion   time "+ String.valueOf(System.currentTimeMillis() - time));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.clear_data) {
            ...
            Log.i("mvvm_room","1000 words deletion time "+ String.valueOf(System.currentTimeMillis() - time));
